...
const LoginComponent: React.FC<LoginProps> = ({ onDiscordLogin, onGithubLogin }) => {
    return (
...
const LogedOut: React.FC = () => {
    return (
        <LoginComponent onDiscordLogin={() => console.log("discord")} onGithubLogin={() => console.log("github")} />
    );
}
