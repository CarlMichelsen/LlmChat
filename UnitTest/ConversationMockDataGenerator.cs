...
{
    public static Guid SampleCreatorIdentifier { get; } = Guid.NewGuid();

    public static ConversationEntityId SeededConversationId { get; } = new ConversationEntityId(Guid.NewGuid());

    public static MessageEntityId SeededInitialMessageId { get; } = new MessageEntityId(Guid.NewGuid());

    public static MessageEntityId SeededSecondMessageId { get; } = new MessageEntityId(Guid.NewGuid());
    ...
    public static ConversationEntity GenerateSampleConversation()
    {
        ...
        return new ConversationEntity
        {
            ...
            CreatorIdentifier = SampleCreatorIdentifier,
            Messages =
            [m1, m2],
